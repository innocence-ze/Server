...
public class Room
{
	...
	static readonly float[,,] birthConfig = new float[2, 3, 6]
	{
		//Camp 1 birth config
        {
			{124f, 3.8f, 149f, 0, 24.9f, 0f},
			{167f, 3.8f, 117f, 0, 21.4f, 0f},
			{201f,  3.8f, 87f, 0, 21.9f, 0f},
        },
		//Camp 2 birth config
        {
			{337f, 3.8f, 404f, 0, -156.8f, 0f},
			{397f, 3.8f, 406f, 0, -156.8f, 0f},
			{437f, 3.8f, 413f, 0, -156.8f, 0f},
        },
	};
